...
module Horner_poly
  ...
  wire signed [14:0] p43cr_cast;  // sfix15_En14
  wire signed [28:0] p43cr_mul_temp;  // sfix29_En18
  wire signed [27:0] ci;  // sfix28_En18
  wire signed [14:0] p44ci_cast;  // sfix15_En14
  wire signed [28:0] p44ci_mul_temp;  // sfix29_En18
  wire signed [28:0] c_re;  // sfix29_En18
  wire signed [28:0] c_im;  // sfix29_En18
  wire signed [28:0] p45c_add_cast;  // sfix29_En18
  wire signed [28:0] p45c_add_cast_1;  // sfix29_En18
  wire signed [28:0] br;  // sfix29_En18
  wire signed [42:0] cr_1;  // sfix43_En32
  wire signed [14:0] p48cr_cast;  // sfix15_En14
  wire signed [43:0] p48cr_mul_temp;  // sfix44_En32
  wire signed [28:0] bi;  // sfix29_En18
  wire signed [42:0] ci_1;  // sfix43_En32
  wire signed [14:0] p49ci_cast;  // sfix15_En14
  wire signed [43:0] p49ci_mul_temp;  // sfix44_En32
  wire signed [43:0] c_re_1;  // sfix44_En32
  wire signed [43:0] c_im_1;  // sfix44_En32
  wire signed [43:0] p50c_add_cast;  // sfix44_En32
  wire signed [43:0] p50c_add_cast_1;  // sfix44_En32
  ...
  assign p43cr_cast = {1'b0, mo1};
  assign p43cr_mul_temp = p43cr_cast * 14'sb00001100110011;
  assign cr = p43cr_mul_temp[27:0];



  assign p44ci_cast = {1'b0, mo1};
  assign p44ci_mul_temp = p44ci_cast * 14'sb00100010101011;
  assign ci = p44ci_mul_temp[27:0];



  assign p45c_add_cast = {cr[27], cr};
  assign c_re = p45c_add_cast + 29'sb11111110110100000000000000000;
  assign p45c_add_cast_1 = {ci[27], ci};
  assign c_im = p45c_add_cast_1 + 29'sb11111011111100000000000000000;
  ...
  assign cr_1 = p48cr_mul_temp[42:0];
  ...
  assign p49ci_cast = {1'b0, mo1};
  assign p49ci_mul_temp = p49ci_cast * bi;
  assign ci_1 = p49ci_mul_temp[42:0];



  assign p50c_add_cast = {cr_1[42], cr_1};
  assign c_re_1 = p50c_add_cast + 44'sh000D0000000;
  assign p50c_add_cast_1 = {ci_1[42], ci_1};
  assign c_im_1 = p50c_add_cast_1 + 44'sh000F0000000;
  ...
  assign y_1_re = pre[46:33];
  assign y_1_im = pim[46:33];
